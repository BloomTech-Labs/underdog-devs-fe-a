...
import { DarkModeToggle, setTheme, getTheme } from '../../common/DarkModeToggle';
    ...
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Layout className="site-layout">
        <Content style={{ margin: '2vh 1vw' }}>
          <Content>
            <div>Hey {userInfo.name}, currently your application is still pending. Please check back again soon!</div>
          </Content>
        </Content>
      </Layout>
    </Layout>
